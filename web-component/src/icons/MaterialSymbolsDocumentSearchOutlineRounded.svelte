<script lang="ts" module>
  export interface MaterialSymbolsDocumentSearchOutlineRoundedProps {
    size?: number;
    class?: string;
  }
</script>
...
<script lang="ts">
  const { size = 0.7, class: className = '' }: MaterialSymbolsDocumentSearchOutlineRoundedProps = $props();
</script>
