<script lang="ts">
  ...
  const { size = 0.7, class: className = "" }: SecGeminiLogoProps = $props();
  const originalGradientStops = [
    { offset: "0", stopColor: "#217bfe" },
    { offset: ".27", stopColor: "#078efb" },
    { offset: ".78", stopColor: "#a190ff" },
    { offset: "1", stopColor: "#bd99fe" },
  ];
</script>
...
<svg
  ...
  viewBox="0 0 101.3 127.07"
>
  <defs>
    <style>
      .cls-11 {
        fill: url(#New_Gradient_Swatch_11-22);
        stroke: url(#New_Gradient_Swatch_11-33);
    ...
    >
      {#each originalGradientStops as stop}
        <stop offset={stop.offset} stop-color={stop.stopColor} />
      {/each}
    </linearGradient>
    <linearGradient
      id="New_Gradient_Swatch_11-22"
      data-name="New Gradient Swatch 1"
      x1=".25"
      x2="101.05"
      xlink:href="#New_Gradient_Swatch_11"
    />
    <linearGradient
      id="New_Gradient_Swatch_11-33"
      data-name="New Gradient Swatch 11"
      x1="0"
      y1="63.53"
      x2="101.3"
  ...
  <g id="Layer_11-22" data-name="Layer 11">
