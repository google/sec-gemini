 ...
 * Type of message
 */
export type MessageType = 'result' | 'debug' | 'info' | 'error' | 'thinking' | 'update' | 'delete' | 'query';
...
export type ModelInfo = {
    ...
    /**
     * The list of subagents that make up the model.
     */
    subagents?: Array<ModelSubAgentInfo>;
};

/**
 * Describes the components of a Sec-Gemini model.
 */
export type ModelSubAgentInfo = {
    /**
    ...
    is_enabled?: boolean;
    /**
     * Whether the component is optional or not.
     */
    is_optional?: boolean;
    /**
     * Whether the component is experimental or not.
     */
    is_experimental?: boolean;
};
