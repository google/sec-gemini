  ...
  public async createSession(options: {
    ...
    if (typeof model === 'string') {
      if (model === 'stable') {
        ...
        throw new Error(`Invalid model identifier string: '${model}'. Use 'stable', 'experimental', or provide a ModelInfoInput object.`);
      }
        ...
        // More robust validation could be added if needed
         ...
         if (!modelIsAvailable) {
             console.warn(`Using provided ModelInfoInput for '${resolvedModel.model_string}', but it wasn't listed in available models.`); // Use logger
         }
